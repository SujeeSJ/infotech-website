...
const starterMessage: Message = {
  role: "assistant",
  content:
    "Hi 👋 I'm Infinotech AI. I'm currently in development, but I'll do my best to help you with your business or digital project. Tell me what you're looking to build.",
};
    ...
    try {
      ...
      setMessages((current) => [
        ...current,
        {
          ...
          content:
            "Infinotech AI is currently being improved and may be temporarily unavailable. For a quick response, please contact our team directly on WhatsApp. We'll be happy to help with your project.",
        ...
        >
          ...
          >
            ...
            <div className="flex items-start gap-3">
              ...
              <p className="text-[11px] leading-5 text-black/55">
                Infinotech AI is still being improved.
                For a quick response, you can contact our
          ...
          <div className="border-t border-black/10 bg-white p-4">
            ...
            <p className="mt-2 text-center text-[10px] text-black/30">
              AI assistant in development • Responses may require review
            </p>
